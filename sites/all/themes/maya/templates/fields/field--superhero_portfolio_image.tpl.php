...
$type = $element['#object']->field_portfolio_type['und'][0]['value'];
//$type: [normal, slider, gallery]
$count = count($items);

if( $type == "slider" || ( $type == "normal" && $count > 1 ) ) :
	$carousel = drupal_html_id('sh-portfolio-carousel');
?>
		...
		<?php foreach ($items as $delta => $item): ?>
			<div class="item <?php if( $delta == 0 ) print 'active'; ?>">
				...
				<div id="intro-message" class="carousel-caption">
					...
					<div class="intro-title"><?php print $item['#item']['title']; ?></div>
					<?php endif; ?>
					
					<?php if( !empty($item['#item']['alt']) ) : ?>
					<div class="intro-subtitle"><?php print $item['#item']['alt']; ?></div>
					<?php endif; ?>
...
<?php $image_id = drupal_html_id('sh-portfolio-gallery'); ?>

<div class="gallery-box portfolio-gallery-box <?php print $classes; ?>"<?php print $attributes; ?>>
	<?php foreach ($items as $delta => $item): ?>
				...
				<div class="gallery-item">
					...
					<div class="gallery-caption">
						...
						<div class="gallery-title">
							<a href="<?php print $path; ?>" rel="lightbox[<?php print $image_id; ?>]"><?php print $title; ?></a>
						</div>
